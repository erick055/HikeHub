...
<body>
        ...
        <div class="cards">
            <div class="trail-card active" data-difficulty="moderate" id="card-pico">
                ...
                <div class="card-footer">
                    <a href="trail_details.php?id=1" class="arrow-link" title="View Details">
            ...
            <div class="trail-card" data-difficulty="easy" id="card-palay">
                ...
                <p class="status open">OPEN</p>
                <div class="card-footer">
                    <a href="trail_details.php?id=2" class="arrow-link" title="View Details">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div class="trail-card" data-difficulty="moderate" id="card-talamitam">
                ...
                <p class="status open">OPEN</p>
                <div class="card-footer">
                    <a href="trail_details.php?id=3" class="arrow-link" title="View Details">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/></svg>
                    </a>
                </div>
            </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const mapEmbeds = {
            'card-pico': 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15478.71881881518!2d120.62768313466496!3d14.214041748283626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd0b1b11e8a4a3%3A0x614a9504c568010f!2sMt.%20Pico%20de%20Loro!5e0!3m2!1sen!2sph!4v1730302000000!5m2!1sen!2sph', // Replace with real map URL if needed
        ...
        cards.forEach(card => {
            card.addEventListener('click', (e) => {
                // Prevent map update if clicking the arrow link directly
                if (e.target.closest('.arrow-link')) return;
